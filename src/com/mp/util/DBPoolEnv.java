 ...
 * </pre>
 */
public class DBPoolEnv extends DBPoolLog {
  
  	/** 모듈명 설정 */
  	private String MNAME = "DBPoolEnv";
	...
	public String getEnv(String name) throws Err {
		...
		if(envhash != null) {
			if(envhash.containsKey(name)) {
				...
				throw new Err("1","6","G","시스템 에러 발생.",pos);
			}
		} else {
